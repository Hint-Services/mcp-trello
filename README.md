[![smithery badge](https://smithery.ai/badge/@HintServices/mcp-trello)](https://smithery.ai/server/@HintServices/mcp-trello)
...
```bash
npx -y @smithery/cli run @HintServices/mcp-trello --client [client-name]
```
